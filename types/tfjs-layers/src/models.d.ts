...
export declare class Sequential extends LayersModel {
    ...
    /** @nocollapse */
    static fromConfig<T extends serialization.Serializable>(cls: serialization.SerializableConstructor<T>, config: serialization.ConfigDict, customObjects?: any, fastWeightInit?: boolean): T;
    /**
