...
export declare class RNN extends Layer {
    ...
    /** @nocollapse */
    static fromConfig<T extends serialization.Serializable>(cls: serialization.SerializableConstructor<T>, config: serialization.ConfigDict, customObjects?: any): T;
}
/**
 * An RNNCell layer.
 *
